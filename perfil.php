            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-xl p-6 text-center">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="main.php" class="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 py-3 px-4 rounded-lg font-medium transition duration-200 flex items-center justify-center">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between py-3 border-b border-gray-100">
                            ...
                            <span class="font-medium text-gray-800"><?php echo $usuario->data_criacao; ?></span>
                        </div>
                    </div>
                </div>
